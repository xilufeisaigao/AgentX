...
6. [Runtime 基础设施设计](runtime/02-runtime-v1-infrastructure.md)
7. [上下文编译中心](runtime/03-context-compilation-center.md)
8. [本地 RAG 与代码索引](runtime/04-local-rag-and-code-indexing.md)
9. [Runtime 收口评估](runtime/05-runtime-closure-assessment.md)
10. [Eval Center V1 总览](evaluation/01-eval-center-overview.md)
11. [Eval 维度目录](evaluation/02-dimension-catalog.md)
12. [Workflow Eval Report Schema](evaluation/03-workflow-report-schema.md)
13. [Scenario Pack 与 Regression](evaluation/04-scenario-pack-and-regression.md)
14. [Eval Report Reader Skill](evaluation/05-agentx-eval-report-reader-skill.md)
15. [严格真实 Workflow Scenario Pack](evaluation/06-real-workflow-scenario-pack.md)
16. [Controlplane V1 Command API](controlplane/01-controlplane-v1-command-api.md)
17. [真实 LLM 全链路 Smoke Findings](agentkernel/01-real-llm-full-flow-smoke-findings.md)
18. [数据库分层真相](database/01-table-layer-map.md)
19. [数据库建表 SQL](../db/schema/agentx_platform_v1.sql)
20. [Deferred 清单](deferred/01-runtime-v1-deferred.md)
...
| `runtime/04-local-rag-and-code-indexing.md` | 本地 RAG、repo index、workflow overlay index、Java symbol retrieval 当前是怎么落地的 |
